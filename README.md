...
**Target model:** Mistral Small 3.1 (24B) loaded via [Unsloth](https://github.com/unslothai/unsloth) in 4-bit quantization.
...
- **Datasets:** HarmBench + JailbreakBench, augmented with 100 fuzzed variants per category
